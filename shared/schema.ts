...
export const programs = pgTable("programs", {
  ...
  partner: text("partner"), // replacing category field
  ...
  documentUrl: text("document_url"), // document attachment URL
  documentName: text("document_name"), // original document filename
  documentType: text("document_type"), // document MIME type
