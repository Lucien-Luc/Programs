...
export function EnhancedLoginForm({ onSuccess }: EnhancedLoginFormProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary/30 via-background to-accent/10 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
